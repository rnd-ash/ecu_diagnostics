...
type GetErrorTextFn = unsafe extern "stdcall" fn(
    error: i32,
    languge: u8,
    buffer: LPSTR
) -> i32;

type GetStatusFn = unsafe extern "stdcall" fn(
    channel: WORD
) -> i32;
...
type InitializeFdFn = unsafe extern "stdcall" fn(
    channel: WORD,
    bitrate: LPSTR
) -> i32;

type LookUpChannelFn = unsafe extern "stdcall" fn(
    paramters: LPSTR,
...
type ResetFn = unsafe extern "stdcall" fn(
    channel: WORD
) -> i32;
...
type UninitalizeFn = unsafe extern "stdcall" fn(
    channel: WORD,
) -> i32;

type WriteFn = unsafe extern "stdcall" fn(
    channel: WORD,
    buffer: *mut TpCanMsg,
) -> i32;

type WriteFdFn = unsafe extern "stdcall" fn(
    channel: WORD,
    buffer: *mut TpCanMsgFD,
) -> i32;
